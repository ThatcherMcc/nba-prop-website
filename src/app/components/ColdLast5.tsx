      ...
      <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
        {players.map((p) => (
          <button
            ...
            className="flex flex-col items-start gap-2 rounded-xl bg-zinc-900/60 border border-white/5 border-l-4 border-l-sky-500 px-5 py-4 transition-all hover:bg-sky-500/10 focus:outline-none focus:ring-2 focus:ring-sky-500/50 text-left cursor-pointer"
          >
      ...
      <div className="md:hidden">
        <div className="relative">
          ...
          <button
            ...
            className="w-full flex flex-col items-start gap-2 rounded-xl bg-zinc-900/60 border border-white/5 border-l-4 border-l-sky-500 px-5 py-5 text-left"
          >
            ...
            >
              <span
                className={`w-2 h-2 rounded-full transition-colors ${
                  i === mobileIndex ? "bg-sky-400" : "bg-zinc-700"
                }`}
              />
            </button>
          ))}
