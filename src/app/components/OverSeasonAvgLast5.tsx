      ...
      <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
        {players.map((p) => (
          <button
            ...
            className="flex flex-col items-start gap-2 rounded-xl bg-pe-surface-1/60 border border-pe-border/5 border-l-4 border-l-emerald-500 px-5 py-4 transition-all hover:bg-emerald-500/10 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 text-left cursor-pointer"
          >
      ...
      <div className="md:hidden">
        <div className="relative">
          ...
          <button
            ...
            className="w-full flex flex-col items-start gap-2 rounded-xl bg-pe-surface-1/60 border border-pe-border/5 border-l-4 border-l-emerald-500 px-5 py-5 text-left"
          >
            ...
            >
              <span
                className={`w-2 h-2 rounded-full transition-colors ${
                  i === mobileIndex ? "bg-emerald-400" : "bg-pe-text-faint"
                }`}
              />
            </button>
          ))}
