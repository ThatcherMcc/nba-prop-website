    ...
    <div className="w-full pb-16">
      ...
      <div className="text-center py-14 sm:py-24 px-4">
        <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[11px] font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-6">
          {hitRate > 0 ? `${hitRate}% verified hit rate` : "AI-powered picks"}
        </div>
        ...
        >
          <div className="p-6 sm:p-8">
            <div className="flex items-start gap-4 sm:gap-5">
              <div className="shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-pe-text-muted leading-relaxed mb-3">
                  Today&apos;s top AI prop picks, ranked by model confidence. Each pick shows the
                  predicted direction, book line, and a visual confidence score — so you know
                  exactly what the model likes and why.
                </p>
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] text-pe-text-faint">
                  <span>&#10003; Up to 20 picks daily</span>
                  <span>&#10003; Confidence-ranked</span>
                  <span>&#10003; Game-by-game breakdowns</span>
                  <span>&#10003; Opponent defense context</span>
                </div>
              </div>
              <svg className="shrink-0 w-5 h-5 text-pe-text-faint group-hover:text-blue-400 transition-colors hidden sm:block mt-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="9 18 15 12 9 6" />
              </svg>
            </div>
          </div>
      ...
      <div className="mt-14 mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <h3 className="text-sm font-bold text-pe-text-primary mb-1">Top picks delivered</h3>
            <p className="text-xs text-pe-text-faint leading-relaxed">
              The highest-confidence picks surface on The Edge every game day, ranked and ready. No noise, just signal.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-pe-surface-1/60 border border-pe-border/10 rounded-2xl p-8 text-center">
        ...
        <p className="text-sm text-pe-text-muted mb-5 max-w-md mx-auto">
          {bestMarket
            ? `Our best market (${bestMarket.market}) is hitting at ${bestMarket.rate}%. See what the model likes today.`
            : "Check out today's AI picks and see the model in action."
          }
        </p>
        <Link
          href="/slate"
